        ...
        <Grid.Row>
          <Grid.Column width={8}>
            ...
            <p style={{ fontSize: "1.33em" }}>
              theGoodEatsCo. is a social media tool built for food lovers. Here,
              you can effortlessly share your favorite dishes from all over the
              world!
            </p>
            <Header as="h3" style={{ fontSize: "2em" }}>
          ...
          <Grid.Column floated="right" width={6}>
            <Image
              ...
              rounded
              size="large"
              src="https://i.imgur.com/d8wczR5.jpg"
            />
          </Grid.Column>
        </Grid.Row>
        <Grid.Row>
      ...
      <Grid.Column>
        <Image.Group>
          <Image
            ...
            rounded
            size="large"
            src="https://i.imgur.com/quwUJ0B.jpg"
          />
          <Image
            bordered
            rounded
            size="large"
            src="https://i.imgur.com/Qd2LppU.jpg"
          />
          <Image
            bordered
            rounded
            size="large"
            src="https://i.imgur.com/vw1auCK.jpg"
          />
          <Image
            bordered
            rounded
            size="large"
            src="https://i.imgur.com/zOXVG0Y.jpg"
          />
          <Image
            bordered
            rounded
            size="large"
            src="https://i.imgur.com/Opi0Vo6.jpg"
          />
        </Image.Group>
      </Grid.Column>
    </Segment>
